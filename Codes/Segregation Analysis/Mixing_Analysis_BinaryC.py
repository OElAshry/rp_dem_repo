...
combined_csv_filename = os.path.join(save_csv_location, "all_simulation_data_plots_binaryC.csv")
...
if all_outlet_rows:
    ...
    outlet_global_csv = os.path.join(save_heatmaps_location, "all_outlet_heatmap_data_plots_binaryC.csv")
...
global_csv = os.path.join(save_csv_location, "global_mixing_data_plots_binaryC.csv")
...
axial_csv = os.path.join(save_csv_location, "axial_profile_data_plots_binaryC.csv")
