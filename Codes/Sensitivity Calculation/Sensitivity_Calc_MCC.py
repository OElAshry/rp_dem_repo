...
selected_simulations = [
    "sim_MCC_1PD_0.5N_200",
    "sim_MCC_1PD_1.5N_1000",
    "sim_MCC_3PD_N_600",
    "sim_MCC_5PD_0.5N_200",
    "sim_MCC_5PD_1.5N_1000"
]
...
if not analyze_all_simulations and not selected_simulations:
    ...
    print("Example: selected_simulations = ['sim_MCC_1PD_1N_100', 'sim_MCC_2PD_1N_100']")
    exit(0)
...
combined_csv_filename = os.path.join(save_location, "sensitivity_ranking_MCC.csv")
